...
/**
 * Exchange an OAuth `code` for a user access token. Used transiently during
 * the connect flow (identity verification + installation listing); never
 * persisted — all git writes use short-lived installation tokens.
 */
